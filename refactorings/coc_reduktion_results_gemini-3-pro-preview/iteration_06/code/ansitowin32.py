...
class AnsiToWin32:
    ...
    def extract_params(self, command, paramstring):
        ...
        return self._extract_params_default(command, paramstring)
    ...
    def _extract_params_default(self, command, paramstring):
    ...
    def _call_win32_cursor(self, command, params):
        n = params[0]
    ...
    def _convert_osc_bel(self, paramstring):
